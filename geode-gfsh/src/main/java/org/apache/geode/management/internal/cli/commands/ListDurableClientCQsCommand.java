...
public class ListDurableClientCQsCommand extends GfshCommand {
  ...
  public ResultModel listDurableClientCQs(
    ...
    final var results = (List<List<CliFunctionResult>>) rc.getResult();

    var result = new ResultModel();
    var table = result.addTable("list-durable-client-cqs");

    for (var perMemberList : results) {
      for (var oneResult : perMemberList) {
