...
public class CreateIndexFunction implements InternalFunction<RegionConfig.Index> {
  ...
  public void execute(FunctionContext<RegionConfig.Index> context) {
    final var indexInfo = context.getArguments();
    ...
    try {
      ...
      var indexedExpression = indexInfo.getExpression();
      var fromClause = indexInfo.getFromClause();
      ...
      var message = CliStrings.format(CliStrings.CREATE_INDEX__INVALID__REGIONPATH,
