...
public class ParallelWANPropagationLoopBackDUnitTest extends WANTestBase {
  ...
  public void testParallelPropagationLoopBack() {
    ...
    // create PR on site1
    vm2.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 0, 100));
    vm4.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 0, 100));
    vm5.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ln", 0, 100));
    ...
    // create PR on site2
    vm3.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ny", 0, 100));
    vm6.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ny", 0, 100));
    vm7.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "ny", 0, 100));
  ...
  public void testParallelPropagationLoopBack3Sites() {
    ...
    vm5.invoke(
        () -> WANTestBase.createPartitionedRegion(getTestMethodName() + "_PR", "tk", 0, 100));
