...
public class AsyncCacheBuilderImpl implements AsyncCacheBuilder {
  ...
  public AsyncCacheBuilder fromCache(final @NotNull Cache cache) {
    return new AsyncCacheBuilderFromCache(cache, executor);
  }

  @Override
  public AsyncCacheBuilder withExecutor(final @NotNull Executor executor) {
