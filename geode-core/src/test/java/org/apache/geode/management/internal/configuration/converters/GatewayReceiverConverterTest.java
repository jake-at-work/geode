...
public class GatewayReceiverConverterTest {
  ...
  public void fromConfig() {
    ...
    config.setEndPort(2);
    var classNameProps = new Properties();
    ...
    var xml = converter.fromConfigObject(config);
    ...
    var xmlTransportFilters = xml.getGatewayTransportFilters();
    assertThat(xmlTransportFilters).hasSize(1);
    var xmlFilter = xmlTransportFilters.get(0);
    assertThat(xmlFilter.getClassName()).isEqualTo("className");
    var xmlFilterParams = xmlFilter.getParameters();
    assertThat(xmlFilterParams).hasSize(1);
    var xmlFilterParam = xmlFilterParams.get(0);
  ...
  public void fromXmlObject() {
    ...
    var configFilters = config.getGatewayTransportFilters();
    assertThat(configFilters).hasSize(1);
    var configFilter = configFilters.get(0);
