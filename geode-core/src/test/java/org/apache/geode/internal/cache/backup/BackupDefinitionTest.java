...
public class BackupDefinitionTest {
  ...
  public void containsConfigFilesAdded() {
    var config1 = Paths.get("config1");
    var config2 = Paths.get("config2");
  ...
  public void containsDeployedJarFilesAdded() {
    var jar1 = Paths.get("jar1");
    var jar2 = Paths.get("jar2");
  ...
  public void containsUserFilesAdded() {
    var userFile1 = Paths.get("userFile1");
    var userFile2 = Paths.get("userFile2");
    var source = Paths.get("source");
  ...
  public void containsAllAddedOplogFilesAdded() {
    ...
    var file1 = mock(Path.class);
    var file2 = mock(Path.class);
  ...
  public void containsAllDiskInitFiles() {
    var diskStore1 = mock(DiskStore.class);
    var diskStore2 = mock(DiskStore.class);
    var diskInit1 = Paths.get("diskInit1");
    var diskInit2 = Paths.get("diskInit2");
