...
public class ParallelGatewaySenderQueueJUnitTest {
  ...
  public void whenPartitionedDataRegionNotReadyShouldNotThrowException() throws Exception {
    ...
    var bucketRegionQueue = mockBucketRegionQueue(backingList);

    var queue = new TestableParallelGatewaySenderQueue(sender,
  ...
  private void testEnqueueToBrqAfterLockFailedInitialImageReadLock(boolean isTmpQueue)
    ...
    var prds = mock(PartitionedRegionDataStore.class);
    var prQ = mock(PartitionedRegion.class);
    var brq = mock(AbstractBucketRegionQueue.class);
    var initializationLock = mock(ReentrantReadWriteLock.class);
    var readLock = mock(ReentrantReadWriteLock.ReadLock.class);
    ...
    var userPR = mock(PartitionedRegion.class);
    PartitionAttributes<?, ?> pa = mock(PartitionAttributes.class);
    ...
    var inOrder = inOrder(brq, readLock);
    queue = spy(queue);
  ...
  public void whenGatewayEventUnableToResolveFromOffHeapTheStatForNotQueuedConflatedShouldBeIncremented()
      throws Exception {
    var stats = mockGatewaySenderStats();

    var event = mock(GatewaySenderEventImpl.class);
    when(event.makeHeapCopyIfOffHeap()).thenReturn(null);
    var eventResolvesFromOffHeap = mock(GatewaySenderEventImpl.class);
  ...
  private GatewaySenderStats mockGatewaySenderStats() {
    var stats = mock(GatewaySenderStats.class);
  ...
  public void isDREventReturnsTrueForDistributedRegionEvent() {
    ...
    var queue = mock(ParallelGatewaySenderQueue.class);
  ...
  public void peekGetsExtraEventsWhenMustGroupTransactionEventsAndNotAllEventsForTransactionsInMaxSizeBatch()
    ...
    var event1 = createGatewaySenderEventImpl(1, false);
    var event2 = createGatewaySenderEventImpl(2, false);
    var event3 = createGatewaySenderEventImpl(1, true);
    var event4 = createGatewaySenderEventImpl(2, true);
    var event5 = createGatewaySenderEventImpl(3, false);
    var event6 = createGatewaySenderEventImpl(3, true);
  ...
  public void peekDoesNotGetExtraEventsWhenNotMustGroupTransactionEventsAndNotAllEventsForTransactionsInBatchMaxSize()
    ...
    var event1 = createGatewaySenderEventImpl(1, false);
    var event2 = createGatewaySenderEventImpl(1, false);
    var event3 = createGatewaySenderEventImpl(2, false);
    var event4 = createGatewaySenderEventImpl(1, true);
    var event5 = createGatewaySenderEventImpl(2, true);
  ...
  public void peekEventsFromIncompleteTransactionsDoesNotThrowConcurrentModificationExceptionWhenCompletingTwoTransactions() {
    ...
    var mockBucketRegion = mockPR("bucketRegion");
  ...
  @Test
  public void testCleanQueueExecuteShadowPRWaitForBucketRecovery() {
    var region = mock(PartitionedRegion.class);
    var regionPath = "/testRegion";
    when(region.getFullPath()).thenReturn(regionPath);
    PartitionAttributes<?, ?> pa = mock(PartitionAttributes.class);
    ...
    var internalCache = mock(InternalCacheForClientAccess.class);
    ...
    var shadowRegion = mock(PartitionedRegion.class);
  ...
  private BucketRegionQueue mockBucketRegionQueue(final Queue<GatewaySenderEventImpl> backingList) {
    ...
    var bucketRegionQueue = mock(BucketRegionQueue.class);
