...
public class SerialGatewaySenderQueueJUnitTest {
  ...
  // @Test
  // public void
  // peekGetsExtraEventsWhenMustGroupTransactionEventsAndNotAllEventsForTransactionsInMaxSizeBatch()
  // {
  ...
  // @Test
  // public void
  // peekGetsExtraEventsWhenMustGroupTransactionEventsAndNotAllEventsForTransactionsInBatchByTime()
  // {
  ...
  // @Test
  // public void
  // peekDoesNotGetExtraEventsWhenNotMustGroupTransactionEventsAndNotAllEventsForTransactionsInBatchMaxSize()
  // {
  // TestableSerialGatewaySenderQueue queue = new TestableSerialGatewaySenderQueue(sender,
  // QUEUE_REGION, metaRegionFactory);
  //
  ...
  // @Test
  // public void
  // peekDoesNotGetExtraEventsWhenNotMustGroupTransactionEventsAndNotAllEventsForTransactionsInBatchByTime()
  // {
  // GatewaySenderEventImpl event1 = createMockGatewaySenderEventImpl(1, false, region);
  // GatewaySenderEventImpl event2 = createMockGatewaySenderEventImpl(2, false, region);
  // GatewaySenderEventImpl event3 = createMockGatewaySenderEventImpl(1, true, region);
  ...
  // @Test
  // public void
  // peekEventsFromIncompleteTransactionsDoesNotThrowConcurrentModificationExceptionWhenCompletingTwoTransactions()
  // {
  // GatewaySenderEventImpl event1 = createMockGatewaySenderEventImpl(1, false, region);
  // GatewaySenderEventImpl event2 = createMockGatewaySenderEventImpl(2, false, region);
  //
