...
public class BitSetExceptionIteratorTest {
  ...
  public void findsLeadingException() {
    ...
    var exceptionIterator = new BitSetExceptionIterator(bitSet, 50, 55);
  ...
  public void findsTrailingException() {
    ...
    var exceptionIterator = new BitSetExceptionIterator(bitSet, 50, 57);
  ...
  public void findsTrailingExceptionDueToLargeVersion() {
    ...
    var exceptionIterator = new BitSetExceptionIterator(bitSet, 50, 61);
  ...
  public void ignoresExceptionsIfNextVersionIsOnePastTheEndOfFullBitset() {
    ...
    var exceptionIterator = new BitSetExceptionIterator(bitSet, 50, 60);
    assertContainsExceptions(exceptionIterator);
  }
  ...
  public void findsMiddleException() {
    ...
    var exceptionIterator = new BitSetExceptionIterator(bitSet, 50, 59);
