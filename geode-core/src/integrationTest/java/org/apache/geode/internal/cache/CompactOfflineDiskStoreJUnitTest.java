...
public class CompactOfflineDiskStoreJUnitTest {
  ...
  public void testTwoEntriesNoCompact() throws Exception {
    ...
    var name = "testTwoEntriesNoCompact";
    ...
    var headerSize = Oplog.OPLOG_MAGIC_SEQ_REC_SIZE + Oplog.OPLOG_DISK_STORE_REC_SIZE;
    var crfsize = headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(0, null, false)
        + Oplog.OPLOG_NEW_ENTRY_BASE_REC_SIZE;
    var createsize1 = getSize4Create(extra_byte_num_per_entry, "key1", "value1");
    var createsize2 = getSize4Create(extra_byte_num_per_entry, "key2", "value2");
    ...
    assertEquals(headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(0, null, true),
        drfFile.length());
    var originalIfLength = ifFile.length();

    var dsi = DiskStoreImpl.offlineCompact(name, diskStore.getDiskDirs(), false, -1);
  ...
  public void testTwoEntriesWithUpdates() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testTwoEntriesWithUpdates";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
    var ifFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + ".if");
    var af = new AttributesFactory();
    af.setDiskStoreName(name);
    af.setDataPolicy(DataPolicy.PERSISTENT_REPLICATE);
    ...
    var createsize1 = getSize4Create(extra_byte_num_per_entry, "key1", "value1");
    var createsize2 = getSize4Create(extra_byte_num_per_entry, "key2", "value2");
    var updatesize1 = getSize4UpdateWithoutKey(extra_byte_num_per_entry, "update1");
    var updatesize2 = getSize4UpdateWithoutKey(extra_byte_num_per_entry, "update2");
  ...
  public void testTwoEntriesWithUpdateAndDestroy() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testTwoEntriesWithUpdateAndDestroy";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
    ...
    var tombstonesize1 = getSize4TombstoneWithoutKey(extra_byte_num_per_entry);
  ...
  public void testbug41862() throws Exception {
    ...
    var createsize1 = getSize4Create(extra_byte_num_per_entry, "key1", "value1");
    var createsize2 = getSize4Create(extra_byte_num_per_entry, "key2", "value2");
    var createsize3 = getSize4Create(extra_byte_num_per_entry, "key3", "value3");
    // 1 tombstone with key
    var tombstonesize1 = getSize4TombstoneWithKey(extra_byte_num_per_entry, "key1");

    assertEquals(crfsize + createsize1 + createsize2, crfFile.length());
    assertEquals(headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(0, null, true),
        drfFile.length());

    var crf2File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_2.crf");
    var drf2File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_2.drf");
    ...
    crfsize =
        headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(1, new int[] {1}, false);
    var updatesize1 = getSize4UpdateWithKey(extra_byte_num_per_entry, "key3", "value3");
    var crf3File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_3.crf");
    var drf3File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_3.drf");
    var krf3File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_3.krf");
  ...
  public void testTwoEntriesWithRegionClear() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testTwoEntriesWithRegionClear";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
    ...
    r.remove("key2");
    r.clear();
    var r2 = cache.createRegion("r2", af.create());
    ...
    var crfsize = headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(0, null, false)
        + Oplog.OPLOG_NEW_ENTRY_BASE_REC_SIZE;
    var clearsize_in_crf = getRVVSize(1, new int[] {1}, false); // write extra RVV and RVVGC for
                                                                // clear operation
    var clearsize_in_drf = getRVVSize(1, new int[] {1}, true); // write extra RVV and RVVGC for
                                                               // clear operation
    var createsize1 = getSize4Create(extra_byte_num_per_entry, "key1", "value1");
    var createsize2 = getSize4Create(extra_byte_num_per_entry, "key2", "value2");
    var updatesize1 = getSize4UpdateWithoutKey(extra_byte_num_per_entry, "update1");
    ...
    // 1 tombstone without key
    var tombstonesize1 = getSize4TombstoneWithoutKey(extra_byte_num_per_entry);
    var createsize3 = getSize4Create(extra_byte_num_per_entry, "r2key1", "rwvalue1");
    assertEquals(crfsize + createsize1 + createsize2 + updatesize1 + updatesize2 + tombstonesize1
    ...
    var updatesize3 = getSize4UpdateWithKey(extra_byte_num_per_entry, "r2key1", "rwvalue1");
    crfsize =
  ...
  public void testTwoEntriesWithRegionDestroy() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testTwoEntriesWithRegionDestroy";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
  ...
  public void testForceRollTwoEntriesWithUpdates() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testForceRollTwoEntriesWithUpdates";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
    ...
    var crfsize = headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(0, null, false)
        + Oplog.OPLOG_NEW_ENTRY_BASE_REC_SIZE;
    var createsize0 = getSize4Create(extra_byte_num_per_entry, "key0", "value0");
    var createsize1 = getSize4Create(extra_byte_num_per_entry, "key1", "value1");
    var createsize2 = getSize4Create(extra_byte_num_per_entry, "key2", "value2");
    var updatesize1 = getSize4UpdateWithKey(extra_byte_num_per_entry, "key1", "update1");
    var updatesize2 = getSize4UpdateWithKey(extra_byte_num_per_entry, "key2", "update2");
    ...
    crfsize =
        headerSize + Oplog.OPLOG_GEMFIRE_VERSION_REC_SIZE + getRVVSize(1, new int[] {1}, false);
    var updatesize0 = getSize4UpdateWithKey(extra_byte_num_per_entry, "key0", "value0");
  ...
  public void testForceRollTwoEntriesWithUpdateAndDestroy() throws Exception {
    var dsf = cache.createDiskStoreFactory();
    dsf.setAutoCompact(false);
    var name = "testForceRollTwoEntriesWithUpdateAndDestroy";
    var diskStore = dsf.create(name);
    var crfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.crf");
    var drfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.drf");
    var krfFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_1.krf");
    var crf2File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_2.crf");
    var drf2File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_2.drf");
    var krf2File = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + "_2.krf");
    var ifFile = new File(diskStore.getDiskDirs()[0], "BACKUP" + name + ".if");
    var af = new AttributesFactory();
    af.setDiskStoreName(name);
    af.setDataPolicy(DataPolicy.PERSISTENT_REPLICATE);
  ...
  static int getSize4Create(int extra_byte_num_per_entry, String key, Object value) {
    var createsize = 1 /* opcode */ + 1 /* userbits */ + versionsize + extra_byte_num_per_entry
  ...
  private static int getSize4UpdateWithoutKey(int extra_byte_num_per_entry, Object value) {
    var updatesize = 1 /* opcode */ + 1 /* userbits */ + versionsize + extra_byte_num_per_entry
  ...
  private static int getSize4TombstoneWithoutKey(int extra_byte_num_per_entry) {
    var tombstonesize = 1 /* opcode */ + 1 /* userbits */ + versionsize + extra_byte_num_per_entry
  ...
  static int getRVVSize(int drMapSize, int[] numOfMemberPerDR, boolean gcRVV) {
    ...
    var dummyHolder = new RegionVersionHolder(1);
    try {
      dummyHolder.toData(out);
    } catch (IOException ignored) {
    }
    var holderSize = out.size();
    out.close();

    var size = 1 /* OPLOG_RVV */;
    size++; /* drMap.size */
    for (var i = 0; i < drMapSize; i++) {
      size++; /* disRegionId */
      if (gcRVV) {
        size++; /* numOfMember, i.e. memberToVersion.size */
        if (numOfMemberPerDR != null && numOfMemberPerDR[i] > 0) {
          for (var j = 0; j < numOfMemberPerDR[i]; j++) {
            size++; /* memberid */
            size++; /* gcversion */
          }
        }
