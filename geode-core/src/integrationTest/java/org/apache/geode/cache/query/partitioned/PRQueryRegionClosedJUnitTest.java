 ...
 * on the same with some delay and then recreating the region instantly.
 *
 *
 */
...
public class PRQueryRegionClosedJUnitTest {
  ...
  public void testQueryingWithRegionClose() throws Exception {
    ...
    try {
      ...
      logger.info(
          "PRQueryRegionClosedJUnitTest#testQueryingWithRegionClose: populating PortfolioData into the PR Datastore  ");
      ...
      logger.info(
          "PRQueryRegionClosedJUnitTest#testQueryingWithRegionClose: Initiating the  Threads");

      t1.start();
      t2.start();

      logger.info(
          "PRQueryRegionClosedJUnitTest#testQueryingWithRegionClose: Waiting for the Threads to join ");
      ...
      e.printStackTrace();
      fail(
          "PRQueryRegionClosedJUnitTest#testQueryingWithRegionClose: Test failed because of exception "
              + e);
