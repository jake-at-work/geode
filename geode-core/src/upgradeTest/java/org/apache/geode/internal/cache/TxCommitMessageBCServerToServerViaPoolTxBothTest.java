...
public class TxCommitMessageBCServerToServerViaPoolTxBothTest extends TxCommitMessageBCTestBase {
  ...
  public void test() throws Exception {
    ...
    var beforeValuesRepl =
        server3.invoke(() -> TxCommitMessageBCTestBase.doGets(regionNameRepl));
    var beforeValuesPart =
        server3.invoke(() -> TxCommitMessageBCTestBase.doGets(regionNamePart));
    server3.invoke(() -> TxCommitMessageBCTestBase.doTxPutsBoth(regionNameRepl,
        regionNamePart));
