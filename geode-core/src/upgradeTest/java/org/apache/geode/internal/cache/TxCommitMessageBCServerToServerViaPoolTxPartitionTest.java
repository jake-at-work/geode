...
public class TxCommitMessageBCServerToServerViaPoolTxPartitionTest
    extends TxCommitMessageBCTestBase {
  ...
  public void test() throws Exception {
    ...
    var beforeValues =
        server3.invoke(() -> TxCommitMessageBCTestBase.doGets(regionName));
    server3.invoke(() -> TxCommitMessageBCTestBase.doTxPuts(regionName));
    var afterValues1 =
        server3.invoke(() -> TxCommitMessageBCTestBase.doGets(regionName));
    var afterValues2 =
