...
public interface ConfigurationProperties {
  ...
  /**
   * The static String definition of the <i>"disable-jmx"</i> property
  ...
  /**
   * The static String definition of the <i>"enable-management-rest-service"</i> property
  ...
  /**
   * The static String definition of the jmx-manager-ssl prefix <i>"jmx-manager-ssl-"</i> property
  ...
  String ROLES = "roles";
  /**
   * The static String definition of the security prefix <i>"security-"</i> property used in
  ...
  /**
   * The static String definition of the <i>"ssl-endpoint-identification-enabled"</i> property
  ...
  /**
   * The static String definition of the <i>"security-auth-token-enabled-components"</i> property
  ...
  /**
   * The static String definition of the <i>"ssl-truststore-type"</i> property
  ...
  /**
   * The static String definition of the <i>"ssl-client-protocols"</i> property
  ...
  /**
   * The static String definition of the <i>"ssl-server-protocols"</i> property
  ...
  /**
   * The static String definition of the <i>"thread-monitor-enabled"</i> property
  ...
  /**
   * The static String definition of the <i>"thread-monitor-interval-ms"</i> property
  ...
  /**
   * The static String definition of the <i>"thread-monitor-time-limit-ms"</i> property
