...
public class DLockStats implements DistributedLockStats {
  ...
  static {
    ...
    type = f.createType(statName, statDescription, new StatisticDescriptor[] {
        f.createLongGauge("grantors", grantorsDesc, "grantors"),
        f.createLongGauge("services", servicesDesc, "services"),
        f.createLongGauge("tokens", tokensDesc, "tokens"),
        f.createLongGauge("grantTokens", grantTokensDesc, "grantTokens"),
        f.createLongGauge("requestQueues", requestQueuesDesc, "requestQueues"),
        ...
        f.createLongGauge("lockWaitsInProgress", lockWaitsInProgressDesc, "operations"),
        f.createLongCounter("lockWaitsCompleted", lockWaitsCompletedDesc, "operations"),
        f.createLongCounter("lockWaitTime", lockWaitTimeDesc, "nanoseconds", false),
        f.createLongCounter("lockWaitsFailed", lockWaitsFailedDesc, "operations"),
        f.createLongCounter("lockWaitFailedTime", lockWaitFailedTimeDesc, "nanoseconds", false),
        f.createLongGauge("grantWaitsInProgress", grantWaitsInProgressDesc, "operations"),
        f.createLongCounter("grantWaitsCompleted", grantWaitsCompletedDesc, "operations"),
        f.createLongCounter("grantWaitTime", grantWaitTimeDesc, "nanoseconds", false),
        f.createLongCounter("grantWaitsNotGrantor", grantWaitsNotGrantorDesc, "operations"),
        f.createLongCounter("grantWaitNotGrantorTime", grantWaitNotGrantorTimeDesc, "nanoseconds",
            false),
        f.createLongCounter("grantWaitsTimeout", grantWaitsTimeoutDesc, "operations"),
        f.createLongCounter("grantWaitTimeoutTime", grantWaitTimeoutTimeDesc, "nanoseconds", false),
        f.createLongCounter("grantWaitsNotHolder", grantWaitsNotHolderDesc, "operations"),
        f.createLongCounter("grantWaitNotHolderTime", grantWaitNotHolderTimeDesc, "nanoseconds",
            false),
        f.createLongCounter("grantWaitsFailed", grantWaitsFailedDesc, "operations"),
        f.createLongCounter("grantWaitFailedTime", grantWaitFailedTimeDesc, "nanoseconds", false),
        f.createLongCounter("grantWaitsSuspended", grantWaitsSuspendedDesc, "operations"),
        f.createLongCounter("grantWaitSuspendedTime", grantWaitSuspendedTimeDesc, "nanoseconds",
            false),
        f.createLongCounter("grantWaitsDestroyed", grantWaitsDestroyedDesc, "operations"),
        f.createLongCounter("grantWaitDestroyedTime", grantWaitDestroyedTimeDesc, "nanoseconds",
            false),
        f.createLongGauge("createGrantorsInProgress", createGrantorsInProgressDesc, "operations"),
        f.createLongCounter("createGrantorsCompleted", createGrantorsCompletedDesc, "operations"),
        f.createLongCounter("createGrantorTime", createGrantorTimeDesc, "nanoseconds", false),
        f.createLongGauge("serviceCreatesInProgress", serviceCreatesInProgressDesc, "operations"),
        f.createLongCounter("serviceCreatesCompleted", serviceCreatesCompletedDesc, "operations"),
        ...
        f.createLongGauge("grantorWaitsInProgress", grantorWaitsInProgressDesc, "operations"),
        f.createLongCounter("grantorWaitsCompleted", grantorWaitsCompletedDesc, "operations"),
        f.createLongCounter("grantorWaitTime", grantorWaitTimeDesc, "nanoseconds", false),
        f.createLongCounter("grantorWaitsFailed", grantorWaitsFailedDesc, "operations"),
        f.createLongCounter("grantorWaitFailedTime", grantorWaitFailedTimeDesc, "nanoseconds",
            false),
        f.createLongGauge("grantorThreadsInProgress", grantorThreadsInProgressDesc, "operations"),
        f.createLongCounter("grantorThreadsCompleted", grantorThreadsCompletedDesc, "operations"),
        ...
        f.createLongGauge("pendingRequests", pendingRequestsDesc, "pendingRequests"),
        f.createLongGauge("destroyReadWaitsInProgress", destroyReadWaitsInProgressDesc,
            "operations"),
        f.createLongCounter("destroyReadWaitsCompleted", destroyReadWaitsCompletedDesc,
            "operations"),
        f.createLongCounter("destroyReadWaitTime", destroyReadWaitTimeDesc, "nanoseconds", false),
        f.createLongCounter("destroyReadWaitsFailed", destroyReadWaitsFailedDesc, "operations"),
        f.createLongCounter("destroyReadWaitFailedTime", destroyReadWaitFailedTimeDesc,
            "nanoseconds", false),
        f.createLongGauge("destroyWriteWaitsInProgress", destroyWriteWaitsInProgressDesc,
            "operations"),
        f.createLongCounter("destroyWriteWaitsCompleted", destroyWriteWaitsCompletedDesc,
            "operations"),
        f.createLongCounter("destroyWriteWaitTime", destroyWriteWaitTimeDesc, "nanoseconds", false),
        f.createLongCounter("destroyWriteWaitsFailed", destroyWriteWaitsFailedDesc, "operations"),
        f.createLongCounter("destroyWriteWaitFailedTime", destroyWriteWaitFailedTimeDesc,
            "nanoseconds", false),
        f.createLongGauge("destroyReads", destroyReadsDesc, "destroyReads"),
        f.createLongGauge("destroyWrites", destroyWritesDesc, "destroyWrites"),
        f.createLongGauge("lockReleasesInProgress", lockReleasesInProgressDesc, "operations"),
        f.createLongCounter("lockReleasesCompleted", lockReleasesCompletedDesc, "operations"),
        f.createLongCounter("lockReleaseTime", lockReleaseTimeDesc, "nanoseconds", false),
        f.createLongCounter("becomeGrantorRequests", becomeGrantorRequestsDesc, "operations"),
        f.createLongCounter("freeResourcesCompleted", freeResourcesCompletedDesc, "operations"),
        f.createLongCounter("freeResourcesFailed", freeResourcesFailedDesc, "operations"),});
