...
public abstract class VMThinRegionEntryOffHeap extends VMThinRegionEntry
  ...
  @Immutable
  private static final VMThinRegionEntryOffHeapFactory factory =
      new VMThinRegionEntryOffHeapFactory();
