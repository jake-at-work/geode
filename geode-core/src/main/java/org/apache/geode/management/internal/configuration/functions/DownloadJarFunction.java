...
public class DownloadJarFunction implements InternalFunction<Object[]> {
  ...
  public void execute(FunctionContext<Object[]> context) {
    ...
    var group = (String) args[0];
    var jarName = (String) args[1];
    ...
    if (locator != null && group != null && jarName != null) {
      ...
      if (sharedConfig != null) {
        var managementService = getExistingManagementService(context);
        var managementAgent = managementService.getManagementAgent();
        ...
        try {
          var jarFile = sharedConfig.getPathToJarOnThisLocator(group, jarName).toFile();

          var exporter = managementAgent.getRemoteStreamExporter();
          istream =
