...
public class ReliableMessagingDUnitTest extends JUnit4DistributedTestCase {
  ...
  public static void waitForClientAck() throws Exception {
    ...
    var iter = pool.getThreadIdToSequenceIdMap().entrySet().iterator();
  ...
  public static void setCreationTimeTidAndSeq() {
    ...
    var args = new Object[] {((ThreadIdentifier) entry.getKey()).getMembershipID(),
  ...
  public static void checkTidAndSeq() {
    var map = HARegionQueue.getDispatchedMessagesMapForTesting();
    ...
    var entry = (Map.Entry) iter.next();
    var dispMap = HAHelper.getDispatchMessageMap(entry.getValue());
  ...
  public static Integer createServerCache() throws Exception {
    var test = new ReliableMessagingDUnitTest();
  ...
  public static void createClientCache(int port1, int port2) throws Exception {
    ...
    cache = test.createCache(props);
    var host = NetworkUtils.getServerHostName(Host.getHost(0));
