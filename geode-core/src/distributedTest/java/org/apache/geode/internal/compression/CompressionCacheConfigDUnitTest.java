...
public class CompressionCacheConfigDUnitTest extends JUnit4CacheTestCase {
   ...
   */
  private void assertCompressorOnVM(final VM vm, final Compressor compressor,
    ...
    return (Boolean) vm.invoke(new SerializableCallable() {
      ...
      public Object call() throws Exception {
        try {
          ...
          LogWriterUtils.getLogWriter()
              .info("<ExpectedException action=remove>ClassNotFoundException</ExpectedException>");
        }
      }
    });
  }
