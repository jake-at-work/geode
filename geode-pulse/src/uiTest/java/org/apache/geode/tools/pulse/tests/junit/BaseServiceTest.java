 ...
 *
 * <b>Sub-classes should ensure that they call doLogin() in @BeforeClass and doLogout()
...
public abstract class BaseServiceTest {
  ...
  protected static void doLogin() throws Exception {
    System.out
        .println("BaseServiceTest ::  Executing doLogin with user : admin, password : admin.");
  ...
  protected static void doLogout() throws Exception {
    System.out
        .println("BaseServiceTest ::  Executing doLogout with user : admin, password : admin.");
    if (httpclient != null) {
