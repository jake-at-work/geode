...
public class HMsetDUnitTest {
  ...
  public void shouldDistributeDataAmongCluster_givenAddingDifferentDataToSameHashConcurrently() {
    ...
    var consumer1 = makeHMSetConsumer(testMap1, testMap1Fields, key, jedis);
    var consumer2 = makeHMSetConsumer(testMap2, testMap2Fields, key, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenAddingSameDataToSameHashConcurrently() {
    ...
    var consumer1 = makeHMSetConsumer(testMap, testMapFields, key, jedis);
    var consumer2 = makeHMSetConsumer(testMap, testMapFields, key, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenAddingToDifferentHashesConcurrently() {
    ...
    var consumer1 = makeHMSetConsumer(testMap1, testMap1Fields, key1, jedis);
    var consumer2 = makeHMSetConsumer(testMap2, testMap2Fields, key2, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingSameDataToSameSetConcurrently() {
    ...
    var consumer1 = makeHMSetConsumer(testMap, testMapFields, key, jedis);
    var consumer1B = makeHMSetConsumer(testMap, testMapFields, key, jedis);
    var consumer2 = makeHMSetConsumer(testMap, testMapFields, key, jedis);
    var consumer2B = makeHMSetConsumer(testMap, testMapFields, key, jedis);
  ...
  public void shouldDistributeDataAmongCluster_givenMultipleThreadsAddingDifferentDataToSameSetConcurrently() {
    ...
    var consumer1 = makeHMSetConsumer(testMap1, testMap1Fields, key, jedis);
    var consumer1B = makeHMSetConsumer(testMap1, testMap1Fields, key, jedis);
    var consumer2 = makeHMSetConsumer(testMap2, testMap2Fields, key, jedis);
    var consumer2B = makeHMSetConsumer(testMap2, testMap2Fields, key, jedis);
