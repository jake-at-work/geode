...
public class SystemPropertyJmxSerialFilterConfigurationFactoryTest {
  ...
  @Test
  public void jmxSerialFilterProperty_isBlankByDefault() {
    assertThat(System.getProperty(PROPERTY_NAME)).isBlank();
  }
  ...
  public void enabledConfiguration_setsJmxSerialFilterProperty()
    ...
    assertThat(System.getProperty(PROPERTY_NAME)).isEqualTo(PATTERN);
  }
  ...
  public void disabledConfiguration_doesNotSetAnySystemProperties()
    ...
    assertThat(System.getProperties()).containsExactlyEntriesOf(propertiesBefore);
  }
}
